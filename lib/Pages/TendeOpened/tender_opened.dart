...
class _TenderOpenedState extends State<TenderOpened> {final List<Map<String, dynamic>> data = [
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text("Tender opened",style: TextStyle(fontSize: 17, color: Colors.white,fontWeight: FontWeight.bold),)),
      ),
      body: Padding(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return ExpansionTile(
              ...
              subtitle: Text("Expiry date: ${data[index]['expiry']}",style: TextStyle(color: Colors.grey),),
